...
from custom_components.vault.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.vault.config_flow_handler.validators import validate_credentials
from custom_components.vault.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME

if TYPE_CHECKING:
    from custom_components.vault.config_flow_handler.options_flow import VaultOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "VaultApiClientAuthenticationError": "auth",
    "VaultApiClientCommunicationError": "connection",
}


class VaultConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.vault.config_flow_handler.options_flow import VaultOptionsFlow  # noqa: PLC0415

        return VaultOptionsFlow()
    ...
    async def async_step_user(
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "documentation_url": "https://github.com/ruaan-deysel/ha-vault-backup",
            },
        )
