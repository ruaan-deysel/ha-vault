"""
Core DataUpdateCoordinator implementation for vault.
...
from custom_components.vault.api import VaultApiClientAuthenticationError, VaultApiClientError
from custom_components.vault.const import LOGGER
...
class VaultDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except VaultApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="vault",
                translation_key="authentication_failed",
            ) from exception
        except VaultApiClientError as exception:
