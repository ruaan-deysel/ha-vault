...
- **Title:** Vault
- **Class prefix:** `Vault`
- **Main code:** `custom_components/vault/`
...
- `entity/` — Base entity class (`VaultEntity`)
...
- Entity MRO: `(PlatformEntity, VaultEntity)` — order matters
...
- Debug level: `custom_components.vault: debug` in `config/configuration.yaml`
