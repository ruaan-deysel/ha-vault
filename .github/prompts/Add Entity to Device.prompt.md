...
- Inherit from `VaultEntity` and platform base class
...
- Entity: `custom_components/vault/[platform]/[entity_name].py`
- Platform: `custom_components/vault/[platform]/__init__.py`
