...
**File:** `custom_components/vault/services.yaml`
...
Create `custom_components/vault/service_actions/[action_name].py`:

```python
"""[Action name] service action for Vault."""
...
**File:** `custom_components/vault/__init__.py`
...
**File:** `custom_components/vault/const.py`
...
3. Find service action: `vault.[action_name]`
...
- **Domain:** `vault`
- **Service actions directory:** `custom_components/vault/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/vault/services.yaml` (legacy filename)
- **Icons:** `custom_components/vault/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/vault/translations/*.json` under `services` key (legacy)
