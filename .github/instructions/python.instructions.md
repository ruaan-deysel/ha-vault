...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Vault`
...
- Inherit from both platform entity and `VaultEntity` (order matters)
...
**Config entry data:** `entry_data: VaultData = hass.data[DOMAIN][entry.entry_id]`
